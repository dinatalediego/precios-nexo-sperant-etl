...
# 0) Parámetros
# =========================
Carpeta   = "Nexo - Lista de Precios"                  # carpeta origen .xls
OUT_DIR   = "Nexo - Actualizado/"     # carpeta destino
AUD_DIR   = os.path.join(OUT_DIR, "Auditoria")

df_sperant = pd.read_excel(Carpeta + "/BD_SPERANT_ACTUAL.xlsx")
...
archivos = {
    ...
    "Matera":         os.path.join(Carpeta, "Matera (3).xls"),
}
